...
const TX = {
  en: {
    ...
    hero_sub:    'No adventurer should vanish without a trace. DeadEnd is a real-time safety platform built for Mangystau\'s most remote terrain.',
    hero_cta1:   'Try the App →',
    hero_cta2:   'See Features',
    stat1_label: 'tourists visit Mangystau yearly',
    stat2_n:     '<30s',
    stat2_label: 'SOS alert response time',
    stat3_label: 'destinations tracked',
    stat4_n:     '48h',
    stat4_label: 'built at hackathon',
    prob_tag:    'The Problem',
    prob_h2:     'Tourists go missing.\nNo one knows where.',
    prob_text:   'Mangystau attracts thousands of adventurers each year. Many head into zones with no cell signal for days. When emergencies happen, MChS arrives with no location, no contacts, no plan.',
    prob_c1_t:   '📡 No Signal Zones',
    prob_c1:     'Up to 50 km of dead zones before popular destinations. Standard navigation fails.',
    prob_c2_t:   '🚑 Slow Response',
    prob_c2:     'Without pre-registered routes, rescue teams waste critical hours searching blind.',
    prob_c3_t:   '📋 No Data',
    prob_c3:     'MChS receives emergency calls with no tourist profile, vehicle, or medical details.',
    feat_tag:    'Features',
    feat_h2:     'Everything MChS needs.\nIn real time.',
    f1_t: 'Live GPS Tracking',    f1: 'Tourist location syncs to MChS dashboard every 15 seconds via Firebase — even in minimal signal areas.',
    f2_t: 'One-Touch SOS',        f2: 'Emergency button sends GPS coords, blood type, contacts, and vehicle info instantly to rescue services.',
    f3_t: 'Smart Checkpoints',    f3: 'Pre-defined route checkpoints with proximity detection. Auto-alert if tourist misses a check-in.',
    f4_t: 'MChS Dashboard',       f4: 'Real-time operations center: risk scoring, rescue workflow, tourist profiles, incident history.',
    f5_t: 'Offline Support',      f5: 'App works without internet. GPS queues locally and syncs automatically on reconnect.',
    f6_t: 'Weather & Mama Tips',  f6: 'Live weather from Open-Meteo with Kazakh-language safety tips for each destination.',
    stack_tag:   'Stack',
    ...
    cta_tag:     'Try It',
    cta_h2:      'Start a trip.\nCome back safe.',
    cta_sub:     'Pick a destination in Mangystau, register your route, and let MChS know where you are. It takes under a minute.',
    cta_btn:     'Open App →',
    footer:      'Built with care for Kazakhstan · Hackathon 2026',
  },
  ...
  ru: {
    ...
    hero_sub:    'Ни один путешественник не должен пропасть без следа. DeadEnd — платформа безопасности в реальном времени для самых труднодоступных мест Мангыстау.',
    hero_cta1:   'Открыть приложение →',
    hero_cta2:   'Возможности',
    stat1_label: 'туристов в год в Мангыстау',
    stat2_n:     '<30с',
    stat2_label: 'время реакции на SOS',
    stat3_label: 'отслеживаемых направлений',
    stat4_n:     '48ч',
    stat4_label: 'создано на хакатоне',
    prob_tag:    'Проблема',
    prob_h2:     'Туристы пропадают.\nНикто не знает где.',
    prob_text:   'Мангыстау привлекает тысячи путешественников ежегодно. Многие уходят в зоны без сотовой связи на дни. Когда происходят ЧП, МЧС приезжает без координат, контактов и плана.',
    prob_c1_t:   '📡 Зоны без сигнала',
    prob_c1:     'До 50 км мёртвых зон перед популярными локациями. Стандартная навигация не работает.',
    prob_c2_t:   '🚑 Медленное реагирование',
    prob_c2:     'Без зарегистрированных маршрутов спасатели тратят критические часы на поиск вслепую.',
    prob_c3_t:   '📋 Нет данных',
    prob_c3:     'МЧС получает звонки без профиля туриста, данных о машине или медицинских сведений.',
    feat_tag:    'Возможности',
    feat_h2:     'Всё что нужно МЧС.\nВ реальном времени.',
    f1_t: 'GPS-трекинг в реальном времени', f1: 'Координаты туриста синхронизируются с дашбордом МЧС через Firebase каждые 15 секунд.',
    f2_t: 'SOS в одно касание',             f2: 'Кнопка экстренного вызова мгновенно отправляет GPS, группу крови, контакты и данные о машине.',
    f3_t: 'Умные чекпоинты',                f3: 'Заранее определённые точки маршрута с автодетектом. Авто-оповещение при пропуске.',
    f4_t: 'Дашборд МЧС',                    f4: 'Центр мониторинга: оценка рисков, рабочий процесс спасения, профили туристов.',
    f5_t: 'Офлайн-режим',                   f5: 'Приложение работает без интернета. GPS накапливается и синхронизируется при подключении.',
    f6_t: 'Погода и советы мамы',           f6: 'Живая погода от Open-Meteo и советы безопасности на казахском языке по каждой локации.',
    stack_tag:   'Стек',
    ...
    cta_tag:     'Попробовать',
    cta_h2:      'Начни поездку.\nВернись живым.',
    cta_sub:     'Выбери направление в Мангыстау, зарегистрируй маршрут и дай МЧС знать где ты. Занимает меньше минуты.',
    cta_btn:     'Открыть приложение →',
    footer:      'Сделано с заботой о Казахстане · Хакатон 2026',
  },
  ...
  kz: {
    ...
    hero_sub:    'Ешбір саяхатшы із-түзсіз жоғалмасын. DeadEnd — Маңғыстаудың ең алыс жерлеріне арналған нақты уақыттағы қауіпсіздік платформасы.',
    hero_cta1:   'Қосымшаны ашу →',
    hero_cta2:   'Мүмкіндіктер',
    stat1_label: 'турист жыл сайын Маңғыстауға келеді',
    stat2_n:     '<30с',
    stat2_label: 'SOS-қа жауап уақыты',
    stat3_label: 'бақыланатын бағыт',
    stat4_n:     '48с',
    stat4_label: 'хакатонда жасалды',
    prob_tag:    'Мәселе',
    prob_h2:     'Туристер жоғалады.\nЕшкім білмейді.',
    prob_text:   'Маңғыстауға жыл сайын мыңдаған саяхатшы келеді. Көпшілігі күндер бойы байланыссыз аймақтарға барады. Авария болғанда ТЖМ координатсыз, байланыссыз, жоспарсыз келеді.',
    prob_c1_t:   '📡 Байланыссыз аймақтар',
    prob_c1:     'Танымал орындарға дейін 50 км байланыссыз аймақ. Стандартты навигация жұмыс істемейді.',
    prob_c2_t:   '🚑 Баяу жауап',
    prob_c2:     'Тіркелген маршруттарсыз құтқарушылар маңызды сағаттарды соқыр іздестіруге жұмсайды.',
    prob_c3_t:   '📋 Деректер жоқ',
    prob_c3:     'ТЖМ турист профилісіз, көлік деректерісіз және медициналық ақпарсыз қоңырау алады.',
    feat_tag:    'Мүмкіндіктер',
    feat_h2:     'ТЖМ-ға қажеттінің бәрі.\nНақты уақытта.',
    f1_t: 'Нақты уақыттағы GPS',          f1: 'Туристің координаттары Firebase арқылы ТЖМ дашбордына 15 секунд сайын жіберіледі.',
    f2_t: 'Бір басуда SOS',               f2: 'Шұғыл батырма GPS, қан тобы, байланыстар мен көлік деректерін лезде жібереді.',
    f3_t: 'Ақылды бекеттер',              f3: 'Алдын ала белгіленген маршрут бекеттері автодетектпен. Бекетті жіберсе авто-хабарлама.',
    f4_t: 'ТЖМ дашборды',                 f4: 'Мониторинг орталығы: тәуекел бағасы, құтқару жұмыс процесі, турист профильдері.',
    f5_t: 'Офлайн режим',                 f5: 'Қосымша интернетсіз жұмыс істейді. GPS жиналып, байланыс орнында синхрондалады.',
    f6_t: 'Ауа райы және ана кеңестері', f6: 'Open-Meteo-дан тікелей ауа райы және қазақ тіліндегі қауіпсіздік кеңестері.',
    stack_tag:   'Стек',
    ...
    cta_tag:     'Байқап көр',
    cta_h2:      'Сапар бастаңыз.\nАман оралыңыз.',
    cta_sub:     'Маңғыстауда бағыт таңдаңыз, маршрутты тіркеңіз және ТЖМ-ге қайда екеніңізді хабарлаңыз. Бір минуттан аз уақыт алады.',
